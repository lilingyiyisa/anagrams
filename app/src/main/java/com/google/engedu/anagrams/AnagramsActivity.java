...
public class AnagramsActivity extends AppCompatActivity {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { //called when app is launched on phone
        ...
        try {
            ...
            dictionary = new AnagramDictionary(new InputStreamReader(inputStream)); //initialize dictionary
        } catch (IOException e) {
        ...
        editText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if (actionId == EditorInfo.IME_ACTION_GO || (
                    ...
                    processWord(editText); // process words from text box
                    handled = true;
                }
                return handled;
            }
    ...
    public boolean defaultAction(View view) {
        ...
        TextView resultView = (TextView) findViewById(R.id.resultView);
        if (currentWord == null) { //show missing anwers
